...
public class YanjiuShengDetailInfoFragment extends Fragment {
	...
	public YanjiuShengDetailInfoFragment(String baseUrl, String newsId,
		...
		new Thread(new Runnable() {
			...
			public void run() {
				if (NetWorkUtils.checkNetState(getActivity())) {
					ArrayList<String> newLists = paseHtml(urlStr, "p");
					if (newLists.isEmpty()) {

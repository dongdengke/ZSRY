...
public class BenkeShengDetailInfoFragment extends Fragment {
	...
	public BenkeShengDetailInfoFragment(String baseUrl, String newsId,
			String flag, News news) {
		super();
		...
		new Thread(new Runnable() {
			...
			public void run() {
				if (NetWorkUtils.checkNetState(getActivity())) {
					ArrayList<String> newLists = paseHtmlContainSpan(urlStr,
							"span");
					if (newLists.isEmpty()) {

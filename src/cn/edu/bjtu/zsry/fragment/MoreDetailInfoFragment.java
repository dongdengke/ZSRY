...
public class MoreDetailInfoFragment extends Fragment {
	...
	private Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case UPDATEUI:
				...
				tv = new TextView(getActivity());
				tv.setText("发布人：北京交通大学软件学院(SCHOOL OF SOFTWARE BJTU) — 服务外包实验教学示范中心(SERVICE OUTSOURCING EXPERIMENTAL TEACHING DEMONSTRATION CENTER)");
				tv.setTextSize(14);
				ll_container.addView(tv);
				tv = new TextView(getActivity());
	...
	public MoreDetailInfoFragment(String baseUrl, String newsId, String flag,
			News news) {
		super();
